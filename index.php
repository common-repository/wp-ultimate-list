...
function wpulist_admin_scripts() {
  ...
  $allowed_pages_styles = array(
    'toplevel_page_wpulist_home',
    'wp-email-subscribe_page_wpulist_mailing_lists',
    'wp-email-subscribe_page_wpulist_mailing_lists_integration',
    'wp-email-subscribe_page_wpulist_subscribers',
    'edit-wpulistform',
  );
  $screen_wpes = get_current_screen()->id;
  if(in_array($screen_wpes, $allowed_pages_styles)){
...
// Will dump a beauty json :3
    return json_decode(json_encode($ip_body), true);
}
